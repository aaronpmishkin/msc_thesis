...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= (1- \alpha_k) f(\wk) + \alpha_k f(\yk) - \frac{1}{2\sgc L}\norm{\grad(\yk)}^2 + \frac{\alpha_k(1-\alpha_k)\gamma_k}{\gamma_{k+1}}\rbr{\frac{\mu}{2} \norm{\yk - v_k}^2 + \abr{\grad(\yk), v_k - \yk}}, \\
        ...
        \E[\phi_{k+1}^*] &\geq (1- \alpha_k) \E[\rbr{f(\wk) - \abr{\grad(\yk), \wk - \yk}}] + \E\bigg[(1-\alpha_k) \abr{\grad(\yk), \wk - \yk} + \alpha_k f(\yk) \\ & \hspace{5em} - \frac{1}{2\sgc L}\norm{\grad(\yk)}^2 \bigg] + \E\sbr{\frac{\alpha_k(1-\alpha_k)\gamma_k}{\gamma_{k+1}}\rbr{\frac{\mu}{2} \norm{\yk - v_k}^2 + \abr{\grad(\yk), v_k - \yk}}} \\
        &\geq  (1-\alpha_k) \E[f(\yk)] + \E\sbr{\alpha_k f(\yk) - \frac{1}{2\sgc L} \norm{\grad(\yk)}^2} \\
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item \( \alpha_{k} = \sqrt{\frac{\gamma_{k+1}}{\sgc L}} = \sqrt{\frac{\mu}{\sgc L}} \);
        \item \( \lambda_{k} = (1 - \alpha_{k-1}) \lambda_{k-1} = \rbr{1 - \sqrt{\frac{\mu}{\sgc L}}}^{k} \).
    \end{itemize}
