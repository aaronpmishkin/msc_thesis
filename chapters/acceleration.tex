...
This is particularly true since the conditions on \( \lambda_k \) guarantee \( \lim_{k \rightarrow \infty} \phi_k \leq f \) point-wise --- ie. \( \phi \) eventually becomes a \emph{global} lower bound on \( f \).
