...
Experimental evidence has long shown that the slow optimization speed of stochastic first-order methods is mitigated when training highly over-parameterized models~\citep{bottou2010largescale, }.
